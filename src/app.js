...
function renderIngredientsBoard() {
  ...
  if (state.Cheese) {
    document.querySelector("#cheese").style.display = "block";
  }
  if (state.Tomatoes) {
  ...
  if (state.Lettuce) {
    document.querySelector("#lettuce").style.display = "block";
  }
}
...
function renderPrice() {
  ...
  document.querySelector(".price-details").textContent = `Total Price: INR ${totalPrice}`;
}
